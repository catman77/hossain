...
from freqtrade.strategy import merge_informative_pair, BooleanParameter, CategoricalParameter, DecimalParameter, IStrategy, IntParameter, informative
# --------------------------------
...
class TrixV23Strategy(IStrategy):
    ...
    #---------------------------#
    buy_params = {'buy_trix_signal_type': 'trigger', 'buy_trix_src': 'low', 'buy_trix_timeperiod': 8, 'buy_trix_signal_timeperiod': 19, 'buy_stoch_rsi_enabled': True, 'buy_rsi_timeperiod': 14, 'buy_stoch_rsi_timeperiod': 14, 'buy_stoch_rsi': 0.901, 'buy_ema_enabled': True, 'buy_ema_src': 'open', 'buy_ema_timeperiod': 10, 'buy_ema_multiplier': 0.85, 'buy_btc_ema_enabled': True, 'buy_btc_ema_multiplier': 0.996, 'buy_btc_ema_timeperiod': 184}
    sell_params = {'sell_trix_signal_type': 'trailing', 'sell_trix_src': 'high', 'sell_trix_timeperiod': 10, 'sell_trix_signal_timeperiod': 19, 'sell_stoch_rsi_enabled': True, 'sell_rsi_timeperiod': 14, 'sell_stoch_rsi_timeperiod': 14, 'sell_stoch_rsi': 0.183, 'sell_atr_enabled': True, 'sell_atr_timeperiod': 30, 'sell_atr_multiplier': 4.99}
    #------------------------------#
    ...
    buy_ema_multiplier = DecimalParameter(0.8, 1.2, decimals=2, default=1.0, space='buy', optimize=False, load=True)
    ...
    plot_config = {'main_plot': {'trix_b_8': {'color': 'blue'}, 'trix_s_10': {'color': 'orange'}, 'ema_b_signal': {'color': 'red'}, 'btc_usdt_close_1h': {'color': 'purple'}, 'btc_usdt_ema_184_1h': {'color': 'yellow'}}, 'subplots': {'TRIX BUY': {'trix_b_pct': {'color': 'blue'}, 'trix_b_signal_19': {'color': 'orange'}}, 'TRIX SELL': {'trix_s_pct': {'color': 'blue'}, 'trix_s_signal_19': {'color': 'orange'}}, 'STOCH RSI': {'b_stoch_rsi': {'color': 'blue'}, 's_stoch_rsi': {'color': 'orange'}}}}
