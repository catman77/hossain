...
class mad(IStrategy):
    ...
    minimal_roi = {'0': 0.028, '10': 0.018, '40': 0.005}
    ...
    buy_params = {'buy_condition_0_enable': False, 'buy_condition_1_enable': True, 'buy_condition_2_enable': True, 'buy_condition_3_enable': True, 'buy_condition_4_enable': True, 'buy_condition_5_enable': True, 'buy_condition_6_enable': True, 'buy_condition_7_enable': True, 'buy_condition_8_enable': True, 'buy_condition_9_enable': True, 'buy_condition_10_enable': True}
    ############################################################################
    # Buy
