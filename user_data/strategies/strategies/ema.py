...
class BBR(IStrategy):
    INTERFACE_VERSION = 3
    # Define the minimal ROI (Return on Investment) that will be used for the strategy
    minimal_roi = {'0': 0.01}
    # Define the stoploss value
    stoploss = -0.1
    # Define the trailing stoploss parameters
    trailing_stop = True
    ...
    timeframe = '5m'
    can_short = True
    # Define the number of startup candle before the strategy should start
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Calculate Bollinger Bands for the RSI
