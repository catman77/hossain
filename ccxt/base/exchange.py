...
class Exchange(object):
    ...
    def fetch_closed_positions(self, symbol: str, params={}):
        raise NotSupported(self.id + ' fetchClosedPositions() is not supported yet')
    ...
    def close_coinex_position(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        raise NotSupported(self.id + ' closeCoinexPosition() is not supported yet')
