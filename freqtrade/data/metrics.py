...
def calculate_underwater(trades: pd.DataFrame,*,date_col: str = "close_date",value_col: str = "profit_ratio",starting_balance: float = 0.0):
    if len(trades) == 0:
        raise ValueError("Trade dataframe empty.")
...
def calculate_max_drawdown(trades: pd.DataFrame,*,date_col: str = "close_date",value_col: str = "profit_abs",starting_balance: float = 0,relative: bool = False) -> DrawDownResult:
    ...
    idxmin = (max_drawdown_df["drawdown_relative"].idxmax()
        if relative
